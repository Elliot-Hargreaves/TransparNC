...
- [x] Add `clap` or use simple `std::env::args()` to parse:
...
## 4. CI/CD Integration
- [x] Add a "Container Integration Test" job to `.github/workflows/build.yml`.
- [x] Ensure the runner has Docker and necessary permissions (GitHub Actions default runners do).

## 5. Success Criteria
- [x] `peer1` can successfully ping `peer2` over the WireGuard-secured TUN interface.
- [x] The test runs entirely automated without manual intervention.
- [x] Code meets all standards defined in `AGENTS.md`.
